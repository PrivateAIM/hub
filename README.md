...
|-----------------------------------------------------------|-----------------|-------------------------------------------------------------------------------------------|
| [client-ui](apps/client-ui)                               | App             | This package contains the web app.                                                        |
...
| [server-core](apps/server-core)                           | Service         | This package contains the core service.                                                   |
| [server-core-worker](apps/server-core-worker)             | Service         | This package contains the core worker service.                                            |
...
| [server-messenger](apps/server-messenger)                 | Service         | This package contains the messenger service.                                              |
| [server-realtime-kit](packages/server-realtime-kit)       | Library         | This package contains helpers/utilities for all socket services.                          |
| [server-storage](apps/server-storage)                     | Service         | This package contains the storage service.                                                |
...
| [server-telemetry](apps/server-telemetry)                 | Service         | This package contains the telemetry service.                                              |
