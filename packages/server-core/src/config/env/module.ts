...
export function useEnv(key?: string) : any {
    ...
    instance = {
        ...
        masterImageOwner: read('MASTER_IMAGE_OWNER', ConfigDefaults.MASTER_IMAGE_OWNER),
        masterImageRepository: read('MASTER_IMAGE_OWNER', ConfigDefaults.MASTER_IMAGE_REPOSITORY),
        masterImagesURL: read('MASTER_IMAGE_URL', ConfigDefaults.MASTER_IMAGE_URL),
        masterImageBranch: read('MASTER_IMAGE_BRANCH', ConfigDefaults.MASTER_IMAGE_BRANCH),
