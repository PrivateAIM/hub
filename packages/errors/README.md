...
<h1 align="center">@privateaim/errors 🚨</h1>

<p align="center">
  <b>The error vocabulary of FLAME Hub.</b><br>
  Root <code>HubError</code> class, typed subclasses, code → HTTP-status mapping &amp; duck-type guards.
</p>

<p align="center">
  <a href="https://www.npmjs.com/package/@privateaim/errors"><img src="https://img.shields.io/npm/v/@privateaim/errors?logo=npm&logoColor=fff&label=npm&color=cb3837" alt="npm version"></a>
  <a href="https://www.npmjs.com/package/@privateaim/errors"><img src="https://img.shields.io/npm/dm/@privateaim/errors?color=cb3837&label=downloads" alt="npm downloads"></a>
