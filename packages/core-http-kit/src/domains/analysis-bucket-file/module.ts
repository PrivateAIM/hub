...
import type { AnalysisBucketFileCreatePayload, AnalysisBucketFileUpdatePayload, IAnalysisBucketFileAPI  } from './types';

export class AnalysisBucketFileAPI extends BaseAPI implements IAnalysisBucketFileAPI {
    async getMany(
