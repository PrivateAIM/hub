...
<h1 align="center">@privateaim/server-telemetry-kit 📊</h1>

<p align="center">
  <b>Server-side telemetry components for FLAME Hub.</b><br>
  Winston transport &amp; AMQP consumers for log / event ingestion.
</p>

<p align="center">
  <a href="https://www.npmjs.com/package/@privateaim/server-telemetry-kit"><img src="https://img.shields.io/npm/v/@privateaim/server-telemetry-kit?logo=npm&logoColor=fff&label=npm&color=cb3837" alt="npm version"></a>
  <a href="https://www.npmjs.com/package/@privateaim/server-telemetry-kit"><img src="https://img.shields.io/npm/dm/@privateaim/server-telemetry-kit?color=cb3837&label=downloads" alt="npm downloads"></a>
