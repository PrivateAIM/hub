...
<h1 align="center">@privateaim/server-realtime-kit ⚡</h1>

<p align="center">
  <b>Socket.io server helpers for FLAME Hub.</b><br>
  Authup authentication middleware &amp; Redis adapter.
</p>

<p align="center">
  <a href="https://www.npmjs.com/package/@privateaim/server-realtime-kit"><img src="https://img.shields.io/npm/v/@privateaim/server-realtime-kit?logo=npm&logoColor=fff&label=npm&color=cb3837" alt="npm version"></a>
  <a href="https://www.npmjs.com/package/@privateaim/server-realtime-kit"><img src="https://img.shields.io/npm/dm/@privateaim/server-realtime-kit?color=cb3837&label=downloads" alt="npm downloads"></a>
