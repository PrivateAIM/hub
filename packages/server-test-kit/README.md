...
<h1 align="center">@privateaim/server-test-kit 🧪</h1>

<p align="center">
  <b>Shared test fakes &amp; helpers for FLAME Hub server packages.</b><br>
  In-memory repositories, permission checkers &amp; actor factories.
</p>

<p align="center">
  <a href="https://www.npmjs.com/package/@privateaim/server-test-kit"><img src="https://img.shields.io/npm/v/@privateaim/server-test-kit?logo=npm&logoColor=fff&label=npm&color=cb3837" alt="npm version"></a>
  <a href="https://www.npmjs.com/package/@privateaim/server-test-kit"><img src="https://img.shields.io/npm/dm/@privateaim/server-test-kit?color=cb3837&label=downloads" alt="npm downloads"></a>
...
```bash
npm install --save-dev @privateaim/server-test-kit
```
