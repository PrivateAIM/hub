...
## [0.8.15](https://github.com/PrivateAIM/hub/compare/v0.8.14...v0.8.15) (2025-07-24)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @privateaim/core-realtime-kit bumped from ^0.7.15 to ^0.7.16
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @privateaim/core-realtime-kit bumped from ^0.7.14 to ^0.7.15
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @privateaim/core-realtime-kit bumped from ^0.7.13 to ^0.7.14
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @privateaim/core-realtime-kit bumped from ^0.7.12 to ^0.7.13
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @privateaim/core-realtime-kit bumped from ^0.7.11 to ^0.7.12
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @privateaim/core-realtime-kit bumped from ^0.7.10 to ^0.7.11
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @privateaim/core-realtime-kit bumped from ^0.7.8 to ^0.7.9
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @privateaim/core-realtime-kit bumped from ^0.7.7 to ^0.7.8
