...
<h1 align="center">@privateaim/server-kit 🔧</h1>

<p align="center">
  <b>Shared server foundation for FLAME Hub services.</b><br>
  Logging, auth, AMQP messaging, Redis, caching &amp; DI infrastructure.
</p>

<p align="center">
  <a href="https://www.npmjs.com/package/@privateaim/server-kit"><img src="https://img.shields.io/npm/v/@privateaim/server-kit?logo=npm&logoColor=fff&label=npm&color=cb3837" alt="npm version"></a>
  <a href="https://www.npmjs.com/package/@privateaim/server-kit"><img src="https://img.shields.io/npm/dm/@privateaim/server-kit?color=cb3837&label=downloads" alt="npm downloads"></a>
