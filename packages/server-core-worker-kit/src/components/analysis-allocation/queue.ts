...
import { AnalysisAllocationQueueRouterRouting, AnalysisAllocationTaskQueueRouterRouting } from './constants';
...
export function buildCoreTaskQueueRouterPayload(
    ...
    return buildQueueRouterPublishPayload({
        ...
        metadata: {
            routing: AnalysisAllocationTaskQueueRouterRouting,
        },
    });
}
...
export function buildCoreEventQueueRouterPayload(
    ...
    return buildQueueRouterPublishPayload({
        ...
        data: cleanupPayload(context.data),
        metadata: {
            routing: AnalysisAllocationQueueRouterRouting,
        },
    });
}
