...
<h1 align="center">@privateaim/server-storage-kit 📦</h1>

<p align="center">
  <b>Server-side storage components for FLAME Hub.</b><br>
  AMQP-driven bucket &amp; file operations.
</p>

<p align="center">
  <a href="https://www.npmjs.com/package/@privateaim/server-storage-kit"><img src="https://img.shields.io/npm/v/@privateaim/server-storage-kit?logo=npm&logoColor=fff&label=npm&color=cb3837" alt="npm version"></a>
  <a href="https://www.npmjs.com/package/@privateaim/server-storage-kit"><img src="https://img.shields.io/npm/dm/@privateaim/server-storage-kit?color=cb3837&label=downloads" alt="npm downloads"></a>
