...
export class ConfigValidator extends Container<Config> {
    protected initialize() {
        ...
        this.mount('masterImagesBranch', { optional: true }, createValidator(zod.string().min(1)));

        this.mount('skipProjectApproval', { optional: true }, createValidator(zod.boolean()));
        this.mount('skipAnalysisApproval', { optional: true }, createValidator(zod.boolean()));
    }
}
