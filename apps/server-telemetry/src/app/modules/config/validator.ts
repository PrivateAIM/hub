...
export class ConfigValidator extends Container<Config> {
    protected initialize() {
        ...
        this.mount('victoriaLogsURL', { optional: true }, createValidator(zod.string().nullable()));
        this.mount('victoriaLogsIngestorURL', { optional: true }, createValidator(zod.string().nullable()));
        this.mount('victoriaLogsQuerierURL', { optional: true }, createValidator(zod.string().nullable()));
    }
}
