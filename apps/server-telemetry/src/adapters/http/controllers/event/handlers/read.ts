...
export async function getOneEventLogRouteHandler(req: Request, res: Response, dataSource: DataSource) : Promise<any> {
...
export async function getManyEventLogRouteHandler(req: Request, res: Response, dataSource: DataSource) : Promise<any> {
    const permissionChecker = useRequestPermissionChecker(req);
    await permissionChecker.preCheckOneOf({
        name: [
            PermissionName.EVENT_READ,
