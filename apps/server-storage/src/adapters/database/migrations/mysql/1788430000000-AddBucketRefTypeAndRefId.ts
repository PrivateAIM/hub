...
export class AddBucketRefTypeAndRefId1788430000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
            ALTER TABLE \`buckets\`
            ADD \`ref_type\` varchar(64) NULL
        `);
        await queryRunner.query(`
            ALTER TABLE \`buckets\`
            ADD \`ref_id\` varchar(64) NULL
        `);
        await queryRunner.query(`
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
            DROP INDEX \`IDX_b6c30722f117d362bbf1b1a554\` ON \`buckets\`
        `);
        await queryRunner.query(`
            DROP INDEX \`IDX_e705f8186e1ddc094e9372f9d5\` ON \`buckets\`
        `);
        await queryRunner.query(`
