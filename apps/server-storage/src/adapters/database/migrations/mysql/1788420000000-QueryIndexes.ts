 ...
 * the query surface and FK_8f5dde5868976a4d18f077ba323. Because no index
 * this migration creates can become a foreign key's only serving index,
 * down() needs no FK drop/re-add wrapping — plain DROP INDEX statements
 * cannot hit "needed in a foreign key constraint".
 *
...
export class QueryIndexes1788420000000 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
            DROP INDEX \`IDX_f0fd36b54e7af4033d35dfc561\` ON \`bucket_files\`
        `);
        await queryRunner.query(`
            DROP INDEX \`IDX_15f90b243807e95b6845685b08\` ON \`bucket_files\`
        `);
        await queryRunner.query(`
            DROP INDEX \`IDX_993b3d4e3dd196627a4d28bfd4\` ON \`bucket_files\`
        `);
        await queryRunner.query(`
            DROP INDEX \`IDX_e9eef3713bf36ac92dac48111b\` ON \`bucket_files\`
        `);
        await queryRunner.query(`
            DROP INDEX \`IDX_7d3f701641e00392e8ecd39748\` ON \`bucket_files\`
        `);
        await queryRunner.query(`
            DROP INDEX \`IDX_eb3ac3c9d7df2f3c1d92276ce6\` ON \`bucket_files\`
        `);
        await queryRunner.query(`
            DROP INDEX \`IDX_9e15eddac66f32f67dbe98c67b\` ON \`bucket_files\`
        `);
        await queryRunner.query(`
            DROP INDEX \`IDX_ebe54b30f9b97d366c3327f2c0\` ON \`buckets\`
        `);
        await queryRunner.query(`
            DROP INDEX \`IDX_30817af7d3f608fb51158af61e\` ON \`buckets\`
        `);
        await queryRunner.query(`
            DROP INDEX \`IDX_aed1c810e2d1aae7192b5740a5\` ON \`buckets\`
        `);
        await queryRunner.query(`
            DROP INDEX \`IDX_3cc1cd582c8444c0d4d9caf40c\` ON \`buckets\`
        `);
        await queryRunner.query(`
            DROP INDEX \`IDX_94f488c8b9119ebd89bc9dbe00\` ON \`buckets\`
        `);
        await queryRunner.query(`
            DROP INDEX \`IDX_8f92b106edc67c4f4af8d24079\` ON \`buckets\`
        `);
    }
}
