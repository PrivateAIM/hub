...
export const bucketSchema = defineSchema<Bucket>({
    ...
    fields: { default: ['id', 'name', 'region', 'createdAt', 'updatedAt', 'realmId', 'actorId', 'actorType', 'refType', 'refId'] },
    filters: { allowed: ['id', 'name', 'realmId', 'actorType', 'actorId', 'refType', 'refId'], indexed: true },
