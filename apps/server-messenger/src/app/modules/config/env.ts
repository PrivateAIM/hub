...
export function useEnv<K extends keyof Environment>(key?: K) : Environment | Environment[K] {
    ...
    instance = {
        ...
        redisConnectionString: orFail(read(EnvironmentInputKey.REDIS_CONNECTION_STRING)),
        authupURL: read(EnvironmentInputKey.AUTHUP_URL, 'http://127.0.0.1:3010/'),
    };
